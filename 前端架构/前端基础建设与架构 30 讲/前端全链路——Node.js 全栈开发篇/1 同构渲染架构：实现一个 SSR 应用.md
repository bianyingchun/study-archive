...
我们对上述代码进行解读：template 函数接受 title、state 和 content 作为参数，拼凑成最终的 HTML 文档，并将 state 挂载到 window.**STATE**中，作为 script 标签内联到 HTML 文档，同时将 SSR 架构下 assets/client.js 脚本或 assets/bundle.js 嵌入。
